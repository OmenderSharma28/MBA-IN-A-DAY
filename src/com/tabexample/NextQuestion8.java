...
public class NextQuestion8 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        imgbtn.setOnClickListener(new OnClickListener()
        {
			...
			{
				Intent i=new Intent(NextQuestion8.this,NextQuestion9.class);
				startActivity(i);
        ...
        rb2.setOnClickListener(new OnClickListener() {
 		...
 		public void onClick(View v) {
 			...
 			Intent intent=new Intent(NextQuestion8.this,NextQuestion9.class);

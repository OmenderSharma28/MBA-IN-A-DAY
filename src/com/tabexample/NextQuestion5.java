...
public class NextQuestion5 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        imgbtn.setOnClickListener(new OnClickListener()
        {
			...
			{
				Intent i=new Intent(NextQuestion5.this,NextQuestion6.class);
				startActivity(i);
        ...
        rb.setOnClickListener(new OnClickListener() {
 		...
 		public void onClick(View v) {
 			...
 			Intent intent=new Intent(NextQuestion5.this,NextQuestion6.class);

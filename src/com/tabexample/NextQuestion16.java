...
public class NextQuestion16 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        imgbtn.setOnClickListener(new OnClickListener()
        {
			...
			{
				Intent i=new Intent(NextQuestion16.this,NextQuestion17.class);
				startActivity(i);
        ...
        rb.setOnClickListener(new OnClickListener() {
 		...
 		public void onClick(View v) {
 			...
 			Intent intent=new Intent(NextQuestion16.this,NextQuestion17.class);

...
public class NextQuestion7 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        imgbtn.setOnClickListener(new OnClickListener()
        {
			...
			{
				Intent i=new Intent(NextQuestion7.this,NextQuestion8.class);
				startActivity(i);
        ...
        rb2.setOnClickListener(new OnClickListener() {
 		...
 		public void onClick(View v) {
 			...
 			Intent intent=new Intent(NextQuestion7.this,NextQuestion8.class);
